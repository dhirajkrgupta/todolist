...
export default function TodoCard({taskInfo}) {
  ...
  return (
    <div ref={cardRef} className="bg-gradient-to-br from-[#bdadea] to-blue-500 bg-[#bdadea] rounded-xl my-2 mx-2 p-2 flex  border-slate-900  items-center card-box-shadow ">
