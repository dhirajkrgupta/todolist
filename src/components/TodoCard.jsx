...
export default function TodoCard(props) {
  ...
  return (
    <div ref={cardRef} className="todo-card bg-gradient-to-br from-[#bdadea] to-blue-500  rounded-xl my-2 mx-2 p-2 flex border-2 border-slate-900 text-slate-900 items-center">
      <input
